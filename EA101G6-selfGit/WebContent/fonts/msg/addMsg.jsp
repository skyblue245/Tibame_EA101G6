...
<table>
	<tr>
		...
		<td><input type="TEXT" name="mbrno" size="45" 
			 value="<%= (msgVO==null)? "1" : msgVO.getMbrno()%>" /></td>
	</tr>
	<tr>
		<td>留言內容:</td>
		<td><input type="TEXT" name="detail" size="45"
			 value="<%= (msgVO==null)? "2" : msgVO.getDetail()%>" /></td>
	</tr>
	
	<tr>
		<td>文章編號:</td>
		<td><input type="TEXT" name="artno" size="45"
			 value="<%= (msgVO==null)? "3" : msgVO.getArtno()%>" /></td>
	</tr>
	<tr>
		<td>顯示狀態:</td>
		<td><input type="TEXT" name="status" size="45"
			 value="<%= (msgVO==null)? "100" : msgVO.getStatus()%>" /></td>
	</tr>
