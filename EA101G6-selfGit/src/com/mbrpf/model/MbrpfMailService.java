...
public class MbrpfMailService extends Thread {
		private MbrpfVO mbrpfVO;
		private String mail;
		private String newPwd;
		private String mbract;
		private String action;//此action讓下面判斷現在要寄的信件是新員工的信還是忘記密碼的信
		
		public MbrpfMailService(){
			
		}
		
		//透過傳進不同的參數，來分辨是新進員工的信件還是忘記密碼的信件
		//將傳進的參數指定給全域變數
		public MbrpfMailService(MbrpfVO mbrpfVO, String mail, String newPwd){
			this.mbrpfVO = mbrpfVO;
			this.mail = mail;
			this.newPwd = newPwd;
		...
		public void getNewPwd() {
			String name = mbrpfVO.getMbrname();
